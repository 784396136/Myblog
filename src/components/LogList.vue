...
@media screen and (max-width: 767px){
    /* 隐藏部分 */
  .data .info_f span:nth-child(2){
      display: none;
  }
}
@media screen and (max-width: 480px){
    .data .info_f span:nth-child(3){
        display: none;
    }
}
@media screen and (max-width: 383px){
    .data .info_f span:nth-child(5){
        display: none;
    }
}
 /* 左侧盒子 */
...
.data .info_f span:hover {
   color: #51aded;
}
.data .info_f .f_right {
    float: right;
}
.data .info_f .f_right a {
    color: #2c3e50; 
}
.data .info .top {
  float: left;
